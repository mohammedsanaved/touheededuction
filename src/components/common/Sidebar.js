    ...
    <Styles>
      ...
      <div className="sidebar" id="sidebar-body">
        ...
        <div className="side-content">
          <h5>About Us</h5>
          <p>
            In the early ninetees, there were no English medium schools in and
            around the vicinity of the village. Thus, Touheed Educational Trust
            Gangulli, a registered charitable organization, with education and
            community service as its prime objective ventured into establishing
            an English medium school in October 1990.
          </p>
        </div>
        ...
        <div className="side-contact">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              <i className="las la-phone"></i>+1 (999) 999 999
            </li>
            <li>
